  ...
  const slides = [
    {
      ...
      description: 'Connect with local sports enthusiasts and stay active together',
    ...
    },
    {
      ...
      description: 'Build projects and learn new skills with fellow tech enthusiasts',
        ...
        >
          ...
          <div className="absolute inset-0 z-20 flex flex-col items-start justify-center px-4 sm:px-6 md:px-12 lg:px-24 xl:px-32">
            ...
            >
              ...
              <button
                className="bg-white text-gray-900 hover:bg-gray-100 duration-300 px-6 sm:px-8 py-3 sm:py-4 rounded-full font-bold flex items-center gap-2 sm:gap-3 group shadow-xl cursor-pointer"
              >
